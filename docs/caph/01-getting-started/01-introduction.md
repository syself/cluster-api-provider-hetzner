...
| `v1.9.x`                                                                                                  | ✅                        | ❔                        |
| `v1.10.x`                                                                                                 | ✅                        | ✅                        |
| `v1.11.x` [start of beta2](https://github.com/kubernetes-sigs/cluster-api/blob/2590bbf151cb35ff43acf08f6427ecfda5cd3df8/docs/book/src/developer/providers/migrations/v1.10-to-v1.11.md) | ❌                        | ✅                        |
| `v1.12.x`                                                                                                 | ❌                        | ✅                        |
| `v1.13.x`                                                                                                 | ❌                        | ✅                        |
