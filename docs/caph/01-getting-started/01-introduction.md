...
| `v1.9.x`                                                                                                  | ✅                        | ❔                        |
| `v1.10.x`                                                                                                 | ✅                        | ✅                        |
| `v1.11.x` [start of beta2](https://release-1-11.cluster-api.sigs.k8s.io/developer/providers/migrations/v1.10-to-v1.11) | ❌                        | ✅                        |
| `v1.12.x`                                                                                                 | ❌                        | ✅                        |
| `v1.13.x`                                                                                                 | ❌                        | ✅                        |
