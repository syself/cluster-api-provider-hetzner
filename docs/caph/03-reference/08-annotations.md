...
| --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Description** | When set to `"true"`, the CIDR suffix (e.g. `/26`) is stripped from the bare-metal machine's NIC IP, and the address is reported as `ExternalIP` (public IP) or `InternalIP` (private IP) in `Machine.status.addresses`. Set it to `"false"` if you want the old (invalid) behavior, where the NIC IP is reported verbatim, including any CIDR suffix, and always classified as `InternalIP`. Currently, the default (no annotation set) is the old behavior. We might switch the default in the future. |
| **Value**       | `"true"` enables this feature. `"false"` (or leaving the annotation unset) keeps the current default, the old behavior.                                                                                                                                                                                                                                                                                                                                                                                  |
| **Auto-Remove** | Disabled: The annotation remains on the resource.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
