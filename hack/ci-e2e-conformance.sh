...
export REGISTRY=quay.io/syself/cluster-api-provider-hetzner
export TAG=e2e
export PULL_POLICY=IfNotPresent

# Builds CAPH images, if missing
if [[ "$(docker images -q "$REGISTRY:$TAG" 2> /dev/null)" == "" ]]; then
...
export GINKGO_FOCUS="Conformance"
