...
type RemediationStrategy struct {
	...
	// It is required, matching the v1beta1 required timeout.
	// +kubebuilder:validation:Minimum=0
	...
	// machine is deleted. Set to 0 to disable the guard, which is why the field
	// stays a pointer: an explicit 0 must be distinguishable from an absent field
	// that defaults to 30m.
