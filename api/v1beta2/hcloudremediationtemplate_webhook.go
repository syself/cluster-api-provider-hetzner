...
//+kubebuilder:webhook:path=/mutate-infrastructure-cluster-x-k8s-io-v1beta2-hcloudremediationtemplate,mutating=true,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=hcloudremediationtemplates,verbs=create;update,versions=v1beta2,name=mhcloudremediationtemplate.kb.io,admissionReviewVersions=v1
...
//+kubebuilder:webhook:path=/validate-infrastructure-cluster-x-k8s-io-v1beta2-hcloudremediationtemplate,mutating=false,failurePolicy=fail,sideEffects=None,groups=infrastructure.cluster.x-k8s.io,resources=hcloudremediationtemplates,verbs=create;update,versions=v1beta2,name=vhcloudremediationtemplate.kb.io,admissionReviewVersions=v1
