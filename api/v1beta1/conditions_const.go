...
const (
	...
	HCloudRemediationReadyV1Beta2Condition = clusterv1.ReadyV1Beta2Condition
	// HCloudRemediationReadyV1Beta2Reason surfaces when the HCloudRemediation is ready.
	HCloudRemediationReadyV1Beta2Reason = clusterv1.ReadyV1Beta2Reason
	// HCloudRemediationNotReadyV1Beta2Reason surfaces when the HCloudRemediation is not ready.
	HCloudRemediationNotReadyV1Beta2Reason = clusterv1.NotReadyV1Beta2Reason
	// HCloudRemediationReadyUnknownV1Beta2Reason surfaces when the HCloudRemediation readiness is unknown.
	HCloudRemediationReadyUnknownV1Beta2Reason = clusterv1.ReadyUnknownV1Beta2Reason
