...
const (
	...
	// HCloudMachineHandleBootStateUnsetV1Beta2Reason indicates the boot state is being initialized.
	HCloudMachineHandleBootStateUnsetV1Beta2Reason = "HandleBootStateUnset"
