...
var hetznerbaremetalmachinetemplatelog = logf.Log.WithName("hetznerbaremetalmachinetemplate-resource")
...
func (r *HetznerBareMetalMachineTemplate) ValidateCreate() error {
	hetznerbaremetalmachinetemplatelog.Info("validate create", "name", r.Name)
...
func (r *HetznerBareMetalMachineTemplate) ValidateUpdate(old runtime.Object) error {
	hetznerbaremetalmachinetemplatelog.Info("validate update", "name", r.Name)
...
func (r *HetznerBareMetalMachineTemplate) ValidateDelete() error {
	hetznerbaremetalmachinetemplatelog.Info("validate delete", "name", r.Name)
