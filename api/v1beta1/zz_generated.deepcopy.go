...
func (in *ControllerGeneratedStatus) DeepCopyInto(out *ControllerGeneratedStatus) {
	*out = *in
	...
	if in.ResetTypes != nil {
		in, out := &in.ResetTypes, &out.ResetTypes
		*out = make([]ResetType, len(*in))
		copy(*out, *in)
	}
	if in.HetznerRobotSSHKey != nil {
		in, out := &in.HetznerRobotSSHKey, &out.HetznerRobotSSHKey
		*out = new(SSHKey)
		**out = **in
	}
	in.GoodSSHCredentials.DeepCopyInto(&out.GoodSSHCredentials)
	in.TriedSSHCredentials.DeepCopyInto(&out.TriedSSHCredentials)
...
func (in *HetznerBareMetalHostSpec) DeepCopyInto(out *HetznerBareMetalHostSpec) {
	*out = *in
	...
	if in.AutoSetupTemplateRef != nil {
		in, out := &in.AutoSetupTemplateRef, &out.AutoSetupTemplateRef
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RobotSSHSecretKeyRef) DeepCopyInto(out *RobotSSHSecretKeyRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RobotSSHSecretKeyRef.
func (in *RobotSSHSecretKeyRef) DeepCopy() *RobotSSHSecretKeyRef {
	if in == nil {
		return nil
	}
	out := new(RobotSSHSecretKeyRef)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *RobotSSHSecretRef) DeepCopyInto(out *RobotSSHSecretRef) {
	*out = *in
	out.Key = in.Key
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new RobotSSHSecretRef.
func (in *RobotSSHSecretRef) DeepCopy() *RobotSSHSecretRef {
	if in == nil {
		return nil
	}
	out := new(RobotSSHSecretRef)
	in.DeepCopyInto(out)
	return out
}
