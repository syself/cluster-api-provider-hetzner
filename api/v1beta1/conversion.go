...
// Convert_v1beta1_HetznerBareMetalMachineTemplateResource_To_v1beta2_HetznerBareMetalMachineTemplateResource converts
// the v1beta1 HetznerBareMetalMachineTemplateResource to v1beta2. The template metadata changes type from the
// deprecated clusterv1beta1.ObjectMeta to clusterv1.ObjectMeta, which carry the same labels and annotations, so those
// are copied by hand and the spec uses the generated converter. The resource is excluded from conversion-gen
// (+k8s:conversion-gen=false) so this pass does not depend on a shared ObjectMeta converter introduced by another
// v1beta2 resource pass.
...
// Convert_v1beta2_HetznerBareMetalMachineTemplateResource_To_v1beta1_HetznerBareMetalMachineTemplateResource converts
// the v1beta2 HetznerBareMetalMachineTemplateResource back to v1beta1, mapping the clusterv1.ObjectMeta labels and
// annotations back to the deprecated clusterv1beta1.ObjectMeta.
