...
type HCloudMachineV1Beta2Status struct {
	...
	// Known condition types are Ready, HCloudTokenAvailable, HCloudRateLimitExceeded, BootstrapReady, ServerCreated, ServerProvisioned, ServerAvailable and Deleting.
	// +optional
	// +listType=map
	// +listMapKey=type
