...
func TestAllControlPlaneInfraMachinesAnnotatedForHTTPHealthCheck(t *testing.T) {
	...
	httpTrue := map[string]string{infrav2.HTTPHealthCheckForControlPlaneLoadBalancerAnnotation: "true"}
	proxyProtocolOnly := map[string]string{infrav2.ProxyProtocolForControlPlaneLoadBalancerAnnotation: "true"}
