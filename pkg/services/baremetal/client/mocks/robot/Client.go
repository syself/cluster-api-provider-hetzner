...
func (_m *Client) RebootBMServer(_a0 int, _a1 v1beta2.RebootType) (*models.ResetPost, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(int, v1beta2.RebootType) (*models.ResetPost, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(int, v1beta2.RebootType) *models.ResetPost); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(int, v1beta2.RebootType) error); ok {
		r1 = rf(_a0, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Client_RebootBMServer_Call) Run(run func(_a0 int, _a1 v1beta2.RebootType)) *Client_RebootBMServer_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int), args[1].(v1beta2.RebootType))
	})
	return _c
}
...
func (_c *Client_RebootBMServer_Call) RunAndReturn(run func(int, v1beta2.RebootType) (*models.ResetPost, error)) *Client_RebootBMServer_Call {
	_c.Call.Return(run)
	return _c
}
